...
AOS.init({
	...
	startEvent: 'DOMContentLoaded', // Start animations when the page is loaded
	initClassName: 'aos-init', // Class applied to elements before animation
	animatedClassName: 'aos-animate', // Class applied to elements after animation
	useClassNames: true, // Use class names to animate elements
  });
  
  // Optional: You can also add AOS animations to specific elements using JavaScript
  const element = document.querySelector('.aos-animation');
  AOS.animate(element, {
	animation: 'fade-up',
	duration: 1000,
  });